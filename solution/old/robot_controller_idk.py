...
#todo: get appropriate coordinates of item based on estimated distance and angle
    ...
    def control_loop(self):
        ...
        match self.state:
            ...
            case State.TURNING:
                ...
                self.navigator.spin(self.turn_direction * ANGULAR_VELOCITY)
                #self.cmd_vel_publisher.publish(msg)
            ...
            case State.COLLECTING:
                ...
                self.current_goal = Point(x = self.x + item.x, y = self.y + item.y)
                self.state = State.NAVIGATING
                #msg = Twist()
                #msg.linear.x = 0.25 * estimated_distance
                #self.navigator.driveOnHeading(speed=0.25 * estimated_distance)
                #msg.angular.z = item.x / 320.0
                #self.cmd_vel_publisher.publish(msg)
                #self.navigator.spin(item.x / 320.0)
